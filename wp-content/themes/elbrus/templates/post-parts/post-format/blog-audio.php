<?php
/**
 * This template is for displaying part of blog format audio.
 *
 * @package Pix-Theme
 * @since 1.0
 */
...
<?php if ( rwmb_meta('post_audio') != '' ) : ?>

<div class="wrap-audio embed-responsive embed-responsive-1by1">
	<?php echo rwmb_meta('post_audio', 'type=oembed'); ?>
</div>
