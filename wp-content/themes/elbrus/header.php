...
<html <?php language_attributes(); ?>>
	<head>
        ...
        <script>
            ...
            fbq('init', '289929901436572'); // Insert your pixel ID here.
            fbq('track', 'PageView');
        </script>
        <noscript>
            <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=289929901436572&ev=PageView&noscript=1"/>
        </noscript>
        <!-- DO NOT MODIFY -->
