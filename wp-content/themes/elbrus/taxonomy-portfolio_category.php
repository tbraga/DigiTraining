...
$elbrus_portfolio_term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
	...
	<div class="container">
		<div class="row">
			...
			<div class="<?php if ( $elbrus_layout == 1 ) : ?>col-lg-12 col-md-12<?php else : ?>col-lg-9 col-md-8<?php endif; ?> col-sm-12 col-xs-12 left-column sidebar-type-<?php echo esc_attr($elbrus_layout); ?>">
				...
				<?php $elbrus_portfolio_category_description = get_term_field( 'description', $elbrus_portfolio_term->term_id, 'portfolio_category' );
				if( !is_wp_error( $elbrus_portfolio_category_description ) && $elbrus_portfolio_category_description != '' ) :
				?>
					<div class="section-heading text-center">
						<div class="section-subtitle"><?php echo wp_kses_post($elbrus_portfolio_category_description);?></div>
				...
				<?php
					...
					$elbrus_portfolio_categories = get_objects_in_term( $elbrus_portfolio_term->term_id, 'portfolio_category');
					...
					$args = array(
								...
								'post__in' => $elbrus_portfolio_categories,
								'paged' => $paged
							);
